    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="{{ asset('assets/img/logo_light.png') }}" class="header-brand-img desktop-logo h-25 w-25" alt="logo">
                <img src="{{ asset('assets/img/logo_light.png') }}" class="header-brand-img light-logo1 h-25 w-25" alt="logo">
            </a>
            <!-- LOGO -->
                            ...
                            <div class="dropdown d-flex profile-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading">
                                        ...
                                        <form action="{{ route('logout') }}" method="POST" class="d-block dropdown-item">    
                                            @csrf
                                            <button type="submit"  class="btn p-0"><i class="dropdown-icon fe fe-alert-circle"></i>Keluar  </button>
                                        </form>
