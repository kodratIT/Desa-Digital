        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body pt-2">
                    <form action="{{ route('manage.data-rt.update',Crypt::encrypt($data->id)) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-lg-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nama" placeholder="001" value="{{ $data->no_rt }}" name="no_rt" class="form-control">
                                </div>
                                @error('no_rt')
