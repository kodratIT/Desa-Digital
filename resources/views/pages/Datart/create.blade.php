            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Buat No RT</h3>
                    </div>
                    <div class="card-body pt-2">
                        <form action="{{ route('manage.data-rt.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <div class="form-group">
                                        <label for="nama">No RT</label>
                                        <input type="text" id="nama" placeholder="001" value="{{ old('name') }}" name="no_rt" class="form-control">
                                        @error('no_rt')
